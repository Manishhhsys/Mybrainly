import type { IconsInter } from "./IconsInterface"



export const DeleteIcon=({onclick}:IconsInter)=>{
    return(<svg onClick={onclick} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-6">
